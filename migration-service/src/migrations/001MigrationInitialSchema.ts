...
export class Migration001InitialSchema implements MigrationInterface {
    ...
    migration001up = fs.readFileSync(path.join(__dirname, 'sql', '001_initial_schema__up.sql'), 'utf8')
    migration001down = fs.readFileSync(path.join(__dirname, 'sql', '001_initial_schema_down.sql'), 'utf8')
