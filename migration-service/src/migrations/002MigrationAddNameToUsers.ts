...
export class Migration002AddNameToUsers implements MigrationInterface {
    ...
    migration001up = fs.readFileSync(path.join(__dirname, 'sql', '002_user_add_name__up.sql'), 'utf8')
    migration001down = fs.readFileSync(path.join(__dirname, 'sql', '002_user_add_name_down.sql'), 'utf8')
